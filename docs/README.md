...
- [forks-and-updates.md](forks-and-updates.md) — Skill-independent first use, verified personal forks and one upstream update before creating a new CLI editing directory.

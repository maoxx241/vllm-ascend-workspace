...
- [agent-first-openviking-spec.md](agent-first-openviking-spec.md) — superseded 2026-09-11 design and implementation history. Its workflow batches, metadata and automated review proposals are not current requirements or commitments.

...
| `.agents/scripts/knowledge_capture.py` | argparse | - | 9 | docs:3, hook:1, other:2, routing:2, script:2, skill-doc:5, test:4 | mixed | supported | .agents/scripts/knowledge_capture.py | vaws knowledge |
| `.agents/scripts/knowledge_export.py` | argparse | - | 7 | docs:1, other:2, routing:2, script:1, skill-doc:3, test:1 | mechanics | supported | .agents/scripts/knowledge_export.py | vaws knowledge |
| `.agents/scripts/knowledge_migrate_v2.py` | argparse | - | 7 | docs:1, routing:1, skill-doc:2, test:1 | mechanics | supported | .agents/scripts/knowledge_migrate_v2.py | vaws knowledge |
| `.agents/scripts/knowledge_query.py` | argparse | - | 9 | docs:2, routing:2, skill-doc:1, test:2 | mechanics | supported | .agents/scripts/knowledge_query.py | vaws knowledge |
| `.agents/scripts/knowledge_validate.py` | argparse | - | 1 | docs:1, other:3, routing:1, script:1, skill-doc:1, test:2 | mechanics | supported | .agents/scripts/knowledge_validate.py | vaws knowledge |
...
| `.agents/scripts/vaws_client_setup.py` | argparse | - | 5 | docs:5, other:2, policy:1, skill-doc:2, test:2 | mechanics | supported | .agents/scripts/vaws_client_setup.py | vaws workspace |
...
| `.agents/scripts/workspace_identity.py` | argparse | summary, ensure, validate-alias, set-alias, decline-alias | 1 | docs:2, routing:1, skill-doc:5 | mechanics | supported | .agents/scripts/workspace_identity.py | vaws workspace |
...
| `.agents/skills/ascend-memory-profiling/scripts/mem_collect.py` | argparse | - | 25 | docs:4, policy:1, routing:1, script:1, skill-doc:2, test:1 | mechanics | supported | .agents/skills/ascend-memory-profiling/scripts/mem_collect.py | vaws profile |
| `.agents/skills/ascend-memory-profiling/scripts/weight_inspector.py` | argparse | - | 0 | docs:2, policy:1, routing:1, script:1, skill-doc:1 | mechanics | payload | .agents/skills/ascend-memory-profiling/scripts/weight_inspector.py | - |
...
| `.agents/skills/ascend-profiling-analysis/scripts/ascend_profile/analyze.py` | argparse | - | 14 | docs:2, policy:1, routing:1, script:2, skill-doc:9, test:1 | mechanics | payload | .agents/skills/ascend-profiling-analysis/scripts/ascend_profile/analyze.py | - |
...
| `.agents/skills/ascend-profiling-analysis/scripts/ascend_profile/sweep.py` | argparse | - | 13 | docs:1, policy:1, routing:1, script:2, skill-doc:4 | mechanics | payload | .agents/skills/ascend-profiling-analysis/scripts/ascend_profile/sweep.py | - |
| `.agents/skills/ascend-profiling-analysis/scripts/dev/golden_db_vs_csv.py` | argparse | - | 4 | docs:1, policy:1, skill-doc:2 | mechanics | harness | .agents/skills/ascend-profiling-analysis/scripts/dev/golden_db_vs_csv.py | - |
| `.agents/skills/ascend-profiling-analysis/scripts/profile_analyze.py` | argparse | - | 25 | docs:2, policy:1, routing:1, script:1, skill-doc:5, test:1 | mechanics | supported | .agents/skills/ascend-profiling-analysis/scripts/profile_analyze.py | vaws profile |
| `.agents/skills/ascend-profiling-analysis/scripts/profile_sweep.py` | argparse | - | 16 | docs:1, policy:1, routing:1, script:1, skill-doc:4 | mechanics | supported | .agents/skills/ascend-profiling-analysis/scripts/profile_sweep.py | vaws profile |
...
| `.agents/skills/npu-fleet-monitor/scripts/manage_monitor.py` | argparse | deploy, start, status, restart, stop | 6 | docs:4, policy:2, routing:4, script:1, skill-doc:1, test:3 | mechanics | supported | .agents/skills/npu-fleet-monitor/scripts/manage_monitor.py | vaws machine |
| `.agents/skills/remote-code-parity/scripts/gc_runtime_cache.py` | argparse | - | 7 | docs:1, routing:1, script:1, skill-doc:3 | mechanics | supported | .agents/skills/remote-code-parity/scripts/gc_runtime_cache.py | vaws sync |
| `.agents/skills/remote-code-parity/scripts/install_consent.py` | argparse | resolve, set, batch-set, resolve-sync-mode, set-sync-mode | 7 | docs:1, routing:1, skill-doc:5 | mechanics | supported | .agents/skills/remote-code-parity/scripts/install_consent.py | vaws sync |
| `.agents/skills/remote-code-parity/scripts/parity_sync.py` | argparse | - | 17 | docs:5, mirror:1, routing:2, script:4, skill-doc:10, test:2 | mechanics | supported | .agents/skills/remote-code-parity/scripts/parity_sync.py | vaws sync |
| `.agents/skills/remote-code-parity/scripts/parity_watch.py` | argparse | - | 2 | docs:1, script:1, skill-doc:3, test:1 | mechanics | supported | .agents/skills/remote-code-parity/scripts/parity_watch.py | vaws sync |
| `.agents/skills/remote-code-parity/scripts/remote_code_parity.py` | bare | - | 0 | docs:4, routing:1, script:2, skill-doc:3, test:2 | mechanics | payload | .agents/skills/remote-code-parity/scripts/remote_code_parity.py | - |
...
| `.agents/skills/repo-init/scripts/install_gh_user.py` | bare | - | 0 | docs:1, policy:1, script:1 | mechanics | supported | .agents/skills/repo-init/scripts/install_gh_user.py | vaws workspace |
| `.agents/skills/repo-init/scripts/repo_init_probe.py` | argparse | - | 1 | docs:1, mirror:1, policy:1, routing:1, skill-doc:4 | mechanics | supported | .agents/skills/repo-init/scripts/repo_init_probe.py | vaws workspace |
...
| `.agents/skills/session-management/scripts/session_status.py` | argparse | - | 2 | docs:1, policy:1, routing:1, skill-doc:1 | mechanics | supported | .agents/skills/session-management/scripts/session_status.py | vaws session |
...
| `.agents/skills/vllm-ascend-serving/scripts/serve_probe_npus.py` | argparse | - | 3 | docs:4, mirror:1, routing:2, skill-doc:6 | mechanics | compatibility | .agents/skills/vllm-ascend-serving/scripts/serve_probe_npus.py | vaws machine |

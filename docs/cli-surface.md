...
| `.agents/hooks/vaws_session.py` | argparse | - | 4 | docs:4, other:1, policy:2, script:3, source-map:1, test:2 | mechanics | hook | .agents/hooks/vaws_session.py | - |
...
| `.agents/scripts/cli_surface_inventory.py` | argparse | - | 3 | test:2 | mechanics | supported | .agents/scripts/cli_surface_inventory.py | vaws lint |
...
| `.agents/scripts/remote_dev.py` | argparse | status, bootstrap, server, hook, tool, env | 6 | client-config:3, docs:5, mirror:24, other:4, policy:1, script:6, source-map:1, test:4 | mechanics | supported | .agents/scripts/remote_dev.py | vaws remote |
...
| `.agents/scripts/vaws.py` | argparse | status, bootstrap, env, hook, task-server | 6 | client-config:2, docs:5, other:4, policy:2, script:2, skill-doc:1, source-map:1, test:3 | mechanics | supported | .agents/scripts/vaws.py | vaws task |
...
| `.agents/scripts/vaws_deps.py` | argparse | status, bootstrap, doctor | 2 | docs:1, script:1, source-map:1, test:2 | mechanics | supported | .agents/scripts/vaws_deps.py | vaws workspace |
...
| `.agents/skills/npu-fleet-monitor/scripts/manage_monitor.py` | argparse | ensure, status, restart, stop | 7 | docs:4, policy:2, routing:3, skill-doc:1, source-map:1, test:2 | mechanics | supported | .agents/skills/npu-fleet-monitor/scripts/manage_monitor.py | vaws machine |

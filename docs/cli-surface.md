...
| `.agents/skills/remote-code-parity/scripts/remote_code_parity.py` | argparse | plan, sync, gc | 12 | docs:4, routing:1, script:2, skill-doc:3, test:2 | mechanics | payload | .agents/skills/remote-code-parity/scripts/remote_code_parity.py | - |

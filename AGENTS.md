...
| `optimize-vllm-ascend-prefill` | Search AISBench Prefill concurrency and scheduler settings for maximum valid throughput under a TTFT SLO, with full artifact archival |
